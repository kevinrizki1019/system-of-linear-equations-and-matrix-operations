...
public class MakeMatriks {
    ...
    public int idxBaris,idxKolom; // Akses idxBaris hanya bisa pada class MakeMatriks sehingga bila ingin mengubah besaran harus menggunakan fungsi SetIndeks dan ingin mengambil bisa menggunakan fungsi GetIndeks
    public double[][] Mat = new double[100][100];

    MakeMatriks() {
    }

    MakeMatriks(int idxBrs, int idxKol) {
        idxBaris=idxBrs;
        idxKolom=idxKol;
    }
